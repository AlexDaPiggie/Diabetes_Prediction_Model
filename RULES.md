...
- **Incremental Implementation:** Execute code cells one by one. Analyze the output graphs and data carefully after each execution before proceeding.
...
- **Clarification First:** During the planning process, ask specific questions to clarify requirements and ensure a profound understanding of the goals before writing code.
